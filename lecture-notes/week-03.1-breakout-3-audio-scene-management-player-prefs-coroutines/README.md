...
|            | Link                                                                                                                                                               |
| ---------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| ← Previous | [Week 02.2 — Breakout: Scriptable Objects & UI](../week-02.2-breakout-2-scriptable-objects-ui/README.md)         |
| → Next     | [Week 04.1 — Breakout: Renderer & Particle Systems](../week-04.1-breakout-4-renderer-particle-systems/README.md) |

...
![](../resources/img/07-images/07-image-7.png)
...
![](../resources/img/07-images/07-image-8.png)
...
![](../resources/img/07-images/07-image-9.png)
...
![](../resources/img/07-images/07-image-10.png)

Add a `Circle Collider 2D` component to the `Player` GameObject.

![](../resources/img/07-images/07-image-11.png)

Add a `Rigidbody2D` component to the `Player` GameObject.

![](../resources/img/07-images/07-image-12.png)

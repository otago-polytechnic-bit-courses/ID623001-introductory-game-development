# Week 01.2 - Breakout: Materials, Components and Scripts

## Navigation

|            | Link                                                                                                                                                                                                                                                    |
| ---------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| ← Previous | [Week 01.1 - GitHub, Unity and Basic Game Mathematics](../week-01.1-github-unity-basic-game-mathematics/README.md)                          |
| → Next     | [Week 02.1 - Breakout: Textures, Prefabs and Input System](../week-02.1-breakout-2-textures-prefabs-prefab-variants-input-system/README.md) |

...
| 3/Toru           | Audio, Scene Management, Player Prefs and Coroutines | Animations, Optimisation, Build, Itch.io        |
...
This course will be taught using [Unity](https://unity.com/download) and [Microsoft Visual Studio Code](https://code.visualstudio.com/download).

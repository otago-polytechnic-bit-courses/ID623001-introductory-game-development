...
\title{Course Directive\\ID623001: Introductory Game Development\\Semester One, 2025}
\date{}
\maketitle
...
\begin{tabular}{ll}
	...
	Timetable:    & Wednesday 10:00 AM D201 and Thursday 10:00 AM D313               
\end{tabular}
...
\begin{tabular}{|c|c|c|}
	...
	1/Tahi           & \multicolumn{2}{c|}{GitHub, Unity, Main Camera, Sprite, Rigidbody 2D, Collider 2D and Script}    \\ \hline
	2/Rua            & \multicolumn{2}{c|}{Physic Material, Tag, Canvas and Text}                    \\ \hline
	3/Toru           & \multicolumn{2}{c|}{Multiple Inputs, Fixed Update, Prefabs, Grid Snap and Panel} \\ \hline 
	4/Whā            & \multicolumn{2}{c|}{Instantiate, Design Patterns, Audio, Scene Management and Assets}                               \\ \hline
	5/Rima           & \multicolumn{2}{c|}{Input Manager, Clamping and Prefab Variants}                                                \\ \hline
	6/Ono            & \multicolumn{2}{c|}{Invoke, API Integration, Player Prefs, Saving and Loading Data}                                                   \\ \hline
	7/Whitu          &  \multicolumn{2}{c|}{UI Animations, LeanTween, and Event Systems}                            \\ \hline

	8/Waru   & \multicolumn{2}{c|}{State Machines, AI Behavior, and Pathfinding}                                                  \\ \hline
	\rowcolor{yellow} \multicolumn{3}{|c|}{Mid Semester Break}                                                                                                                         \\ \hline
	9/Whitu   & \multicolumn{2}{c|}{Testing and Debugging}                                                  \\ \hline
	10/Tekau         & \multicolumn{2}{c|}{Build Settings, Optimisation, and Publishing}                                                                 \\ \hline
	11/Tekau mā tahi & \multicolumn{2}{c|}{Portfolio Work}                                                                \\ \hline
	12/Tekau mā rua  & \multicolumn{2}{c|}{Portfolio Work}                                                                 \\ \hline
	13/Tekau mā toru & \multicolumn{2}{c|}{Portfolio Work}                                                     \\ \hline
	14/Tekau mā whā  & \multicolumn{2}{c|}{Portfolio Work} \\ \hline 
	15/Tekau mā rima & \multicolumn{2}{c|}{Portfolio Work Due}                                                       \\ \hline
